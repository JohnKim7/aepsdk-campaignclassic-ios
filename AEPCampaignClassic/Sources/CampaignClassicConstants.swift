...
enum CampaignClassicConstants {
    ...
    static let REGISTRATION_PAYLOAD_FORMAT = "registrationToken=%@&mobileAppUuid=%@&userKey=%@&enabled_notifs=%@&deviceName=%@&deviceModel=%@&deviceBrand=%@&deviceManufacturer=%@&osName=%@&osVersion=%@&osLanguage=%@&additionalParams="
